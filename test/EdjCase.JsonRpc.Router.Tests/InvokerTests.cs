...
namespace EdjCase.JsonRpc.Router.Tests
{
	public class InvokerTests
	{
		...
		//	RpcResponse stringResponse = await invoker.InvokeRequestAsync(stringRequest, route, HttpC);
		...
		//	route.AddClass<TestRouteClass>();
		//	IRpcInvoker invoker = new DefaultRpcInvoker();
		//	RpcResponse response = await invoker.InvokeRequestAsync(stringRequest, route);
